...
export class CommentsService {
    ...
    async getAllCommentsOnArticlesDeatils(article: string): Promise<Comment[]> {
        return await this.commentsModel.find({ article }).populate({ path: 'user', select: `${SELECT} -user` }).select(SELECT)
    }
